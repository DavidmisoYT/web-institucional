                ...
                <div className='Informacion-g'>
                    ...
                    <div className={`MasInfo ${info ? 'isActive' : ''}`}>
                        <ul>
                            ...
                            <li className="MasInfo-li-ev" onClick={togglePadre}>Padre:  {studentData.padre}
                            ...
                            <li className="MasInfo-li-ev" onClick={toggleMadre}>Madre: {studentData.madre}
                            ...
                            <li className="MasInfo-li-ev" onClick={toggleAcudiente}>Acudiente: {studentData.acudiente}
